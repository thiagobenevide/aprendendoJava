...
public class LoginGUITratamentoNaPropriaClasseComClasseInternaAnonima extends JFrame implements ActionListener{
	...
	public LoginGUITratamentoNaPropriaClasseComClasseInternaAnonima() {
		super("Título");
		setSize(200, 200);
