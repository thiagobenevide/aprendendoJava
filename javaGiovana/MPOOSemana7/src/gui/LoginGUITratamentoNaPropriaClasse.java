...
public class LoginGUITratamentoNaPropriaClasse extends JFrame implements ActionListener{
	...
	public LoginGUITratamentoNaPropriaClasse() {
		super("Título");
		setSize(200, 200);
	...
	// realiza o tratamento na propria classe
