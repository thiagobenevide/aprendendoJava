...
public class CadastrarFuncionarioPanel extends JPanel {
	...
	public CadastrarFuncionarioPanel() {
		...
		add(getPainelTituloFuncionario(), BorderLayout.NORTH);
		add(getPainelCentralFuncionario(), BorderLayout.CENTER);
		add(getAdicionarFuncionarioButton(), BorderLayout.EAST);
	
		//painelCentralFuncionario.setVisible(false);
